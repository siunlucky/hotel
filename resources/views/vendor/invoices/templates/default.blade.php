                ...
                <tr>
                    ...
                    <td class="pl-0 border-0">
                        @if($invoice->status)
                            ...
                            <h4 class="text-green-400 text-uppercase">
                                <strong>Approved</strong>
                            </h4>
                            @elseif($invoice->status == "check_in")
                            <h4 class="text-blue-500 text-uppercase">
                                <strong>Check In</strong>
                            </h4>
                            @elseif($invoice->status == "check_out")
                            <h4 class="text-gray-500 text-uppercase">
                                <strong>Check Out</strong>
                            </h4>
                            @elseif($invoice->status == "cancelled")
                            <h4 class="text-red-500 text-uppercase">
                                <strong>Cancelled</strong>
                            </h4>
                            @else
                            <h4 class="cool-gray text-uppercase">

...
@section('pages')
    <div class="h-auto px-4 pt-6">
        <form action="/hotel/admin/room-types/create/store" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                for (var i = 1; i <= totalRooms; i++) {
                    var formHtml =
                        ...
                        ' <span class="text-red-500">*<span></label> \
                                                                                                                                                                                                                                                                <div class="relative"> \
                                                                                                                                                                                                                                                                    <input type="text" class="w-full rounded-md" name="rooms[]" id="room-' +
                        i +
                        '"> \
                        ...
                        ' <span class="text-red-500">*<span></label> \
                                                                                                                                                                                                                                                                <div class="relative"> \
                                                                                                                                                                                                                                                                    <select type="text" name="beds[]" required class="w-full rounded-md"> \
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        @foreach ($beds as $bed) \
                                                                                                                                                                                                                                                                        <option class="text-[16px] py-2" id="bed-' +
                        i +

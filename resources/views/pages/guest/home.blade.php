            ...
            <div class="mt-5">
                <form action="">
                    <div class="p-[1.25rem] bg-[#816e5754] border-[#ab8a625d] border-2 rounded-md">
                        <div class="">
                            <div date-rangepicker class="grid grid-cols-4 gap-4">
                                <div class="relative">
    ...
    <div class="container py-20 px-28">
        ...
        <div class="grid grid-cols-3 gap-x-4 gap-y-8">
            <div class="relative">
                <div class="">
                    <div class="h-[435px]">
                        <div class="absolute">
                            <ul class="ml-7 mt-14">
                                ...
                                <div id="washing_machine" role="tooltip"
                                    class="absolute z-10 invisible inline-block w-[138px] px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                    Washing Machine
                                    <div class="tooltip-arrow" data-popper-arrow></div>
                                </div>
                        ...
                        <img src="assets/image/list1.jpg" class="min-h-[350px] rounded" alt="">
                    </div>
                    <div
                        ...
                        <h3 class="text-[25px] font-bold">Executive Suite</h3>
                        <div class="mt-2">
                            <h6 class="text-[#AB8A62] text-[18px] font-semibold">100.00 USD / Night</h6>
                            <div class="flex mt-4 justify-evenly">
                                <div class="bg-[#E5E5E5] py-2 px-5 rounded border-[#d7d7d7]">
                                    <h4 class="text-[15px] text-[#787878] font-medium">People &nbsp 4</h4>
                                </div>
                                <a href="/book-online/1" class="bg-[#AB8A62] text-white py-2 px-3 rounded">
                                    <div class="flex">
            ...
            <div class="relative">
                <div class="">
                    <div class="h-[435px]">
                        <img src="assets/image/list2.jpg" class="min-h-[350px] rounded" alt="">
                    </div>
                    <div
                        class="absolute bottom-0 mx-7 left-0 right-0 p-[1.25rem] rounded-md border-[#ab8a625d] border-2 bg-[#F4F2F0]">
                        <h3 class="text-[25px] font-bold">Executive Suite</h3>
                        <div class="mt-2">
                            <h6 class="text-[#AB8A62] text-[18px] font-semibold">100.00 USD / Night</h6>
                            <div class="flex mt-4 justify-evenly">
                                ...
                                <a href="/" class="bg-[#AB8A62] text-white py-2 px-3 rounded">
                                    <div class="flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 mr-2" viewBox="0 0 576 512">
                                            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                            <path fill="#ffffff"
            ...
            <div class="relative">
                <div class="">
                    <div class="h-[435px]">
                        <img src="assets/image/list3.jpg" class="min-h-[350px] rounded" alt="">
                    </div>
                    <div
                        class="absolute bottom-0 mx-7 left-0 right-0 p-[1.25rem] rounded-md border-[#ab8a625d] border-2 bg-[#F4F2F0]">
                        <h3 class="text-[25px] font-bold">Executive Suite</h3>
            ...
            <div class="relative">
                <div class="">
                    <div class="h-[435px]">
                        <img src="assets/image/list4.jpg" class="min-h-[350px] rounded" alt="">
                    </div>
                    <div
                        class="absolute bottom-0 mx-7 left-0 right-0 p-[1.25rem] rounded-md border-[#ab8a625d] border-2 bg-[#F4F2F0]">
                        <h3 class="text-[25px] font-bold">Executive Suite</h3>

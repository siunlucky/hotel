...
<section class="z-20 bg-center bg-no-repeat bg-cover bg-room_type">
    <div class="p-16 text-center">
        <h1 class="text-white text-[33px] font-bold">{{ $room_type->room_type_name }}</h1>
    </div>
</section>
    ...
    <div class="container py-20 px-28">
        <div class="grid justify-between grid-cols-3 gap-7">
            <div class="relative col-span-2">
                <div class="h-[70px]">
                    <div class="absolute top-0 left-0 right-0 flex justify-around py-6 mx-20 bg-white rounded-md ">
                        <div class="text-center text-[#66625D]">
                            <h1 class="text-[43px]">{{ $room_type->room_type_name }}</h1>
                ...
                <div class="">
                    <img src="/assets/image/{{ $room_type->photo }}" class="rounded-md" alt="">
                </div>
            </div>
                ...
                <div class="bg-white rounded-md p-[2.5rem]">
                    <form action="">
                        <div date-rangepicker>
                            ...
                            <div class="mb-7">
                                <label class="font-semibold" for="rooms">Rooms</label>
                                <div class="relative pt-2">
                            ...
                            <div>
                                <button class="p-3 w-full rounded-md text-white font-semibold bg-[#C9B399]">SEND BOOK
                                    REQUEST</button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-span-2 px-24">
                <div class="grid justify-between grid-cols-3 gap-5">
                    <img class="rounded-md" src="/assets/image/type_room_detail1.jpg" alt="">
                    <img class="rounded-md" src="/assets/image/type_room_detail2.jpg" alt="">
                    <img class="rounded-md" src="/assets/image/type_room_detail3.jpg" alt="">
                </div>

            </div>

            <div class="col-span-2 px-5 py-2 pt-5 bg-white">
            ...
            <div class="col-span-2 px-5 py-1 pt-5 bg-white">
                <div class="border-[#efefef] border-b pb-3">
                ...
                <div class="flex amenities">
                    ...
                    <div class="flex mr-10">
                        ...
                        <p class="text-[#66625d] py-3 px-2 leading-7">
                            {{ $room_amenity->Amenities->amenities_name }}
                        </p>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="col-span-2 px-5 py-1 pt-5 bg-white">
                ...
                <div class="flex complements">
                    <div class="flex mr-10 wifi">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4" viewBox="0 0 512 512">
                            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path fill="#66625d"
                        ...
                        <p class="text-[#66625d] py-3 px-2 leading-7">Breakfast</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-2 px-5 py-1 pt-5 bg-white">
                ...
                <div class="flex beds">
                    <div class="flex mr-10 single">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4" viewBox="0 0 512 512">
                            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path fill="#66625d"
                                d="M374.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 178.7l-57.4-57.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l80 80c12.5 12.5 32.8 12.5 45.3 0l160-160zm96 128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 402.7 86.6 297.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l256-256z" />
                        </svg>
                        <p class="text-[#66625d] py-3 px-2 leading-7">Single</p>
                    </div>
                    <div class="flex mr-10 double">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4" viewBox="0 0 512 512">
                            <!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path fill="#66625d"
                                d="M374.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 178.7l-57.4-57.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l80 80c12.5 12.5 32.8 12.5 45.3 0l160-160zm96 128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 402.7 86.6 297.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l256-256z" />
                        </svg>
                        <p class="text-[#66625d] py-3 px-2 leading-7">Double</p>
                    </div>
                </div>
            </div>
        </div>

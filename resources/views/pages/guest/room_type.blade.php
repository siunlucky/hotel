            ...
            <div class="relative">
                <div class="">
                    <div class="h-[435px]">
                        ...
                        <img src="assets/image/{{ $type_room->photo }}" class="min-h-[350px] rounded" alt="">
                    </div>
                    <div
                        ...
                        <h3 class="text-[25px] font-bold">{{ $type_room->room_type_name }}</h3>
                        <div class="mt-2">
                            <h6 class="text-[#AB8A62] text-[18px] font-semibold">{{ $type_room->price }}.00 USD / Night
                            </h6>
                            <div class="flex mt-4 justify-evenly">
                                ...
                                <a href="/book-online/{{ $type_room->id }}"

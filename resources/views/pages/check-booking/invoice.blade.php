    ...
    <section class="p-10 mx-20 my-5">
        <div class="p-5 border-2 rounded-lg">
            <div class="flex items-center justify-between pb-2 border-b-2">
                <div class="">
                    <h1 class="text-[20px] font-semibold">{{ $booking_number }}</h1>
                    <h1 class="text-sm font-normal">{{ date('d M Y', strtotime($created_at)); }}</h1>
                </div>
                <div class="flex">

                    @if ($booking_status == 'requested')
            ...
            <div class="grid grid-cols-2 mt-5">
                <div class="grid grid-cols-3 gap-2">
                    ...
                    <span class="col-span-2 font-semibold">{{ $booking_number }}</span>

                    <h1 class="col-span-1 font-normal">Name</h1>
                    <span class="col-span-2 font-semibold">{{ $booking_name }}</span>

                    <h1 class="col-span-1 font-normal">Email</h1>
                    <span class="col-span-2 font-semibold">{{ $booking_email }}</span>

                    <h1 class="col-span-1 font-normal">Phone</h1>
                    <span class="col-span-2 font-semibold">{{ $booking_phone }}</span>

                </div>
                <div class="grid grid-cols-3 gap-2">
                    <h1 class="col-span-1 font-normal">Check In Date</h1>
                    <span class="col-span-2 font-semibold">{{ date('D, d M Y', strtotime($check_in_date)); }}</span>

                    <h1 class="col-span-1 font-normal">Check Out Date</h1>
                    <span class="col-span-2 font-semibold">{{ date('D, d M Y', strtotime($check_out_date)); }}</span>
                    ...
                    <span class="col-span-2 font-semibold">{{ $total_room }}</span>
                </div>
                ...
                <div class="grid grid-cols-2 col-span-2 gap-2 pt-5 my-5 border-t-2">
                    ...
                    <div class="">
                        ...
                        <h1 class="text-sm font-normal">{{ date('D, d M Y', strtotime($check_in_date)); }}</h1>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="col-span-2 pt-5 border-t-2">
                    ...
                    <div class="grid grid-cols-5 col-span-2 gap-2 my-5">
                        <h1 class="col-span-1 font-normal">Total Room</h1>
                        <span class="col-span-4 font-semibold text-right">{{ $total_room }}</span>

                        <h1 class="col-span-1 font-normal">Price / Room</h1>
                        <span class="col-span-4 font-semibold text-right">$ {{ $price }}.00</span>

                        <h1 class="col-span-1 font-normal">Days</h1>
                        <span class="col-span-4 font-semibold text-right">{{ \Carbon\Carbon::parse($check_in_date)->diffInDays($check_out_date); }}</span>
                    ...
                    <div class="grid grid-cols-5 col-span-2 gap-2 pt-5 my-5 border-t-2">
                        ...
                        <span class="col-span-4 text-[18px] font-bold text-right">$ {{ $price * $total_room *
                            \Carbon\Carbon::parse($check_in_date)->diffInDays($check_out_date);
                            }}.00</span>
